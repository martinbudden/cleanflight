...
const clivalue_t valueTable[] = {
    ...
    { "dterm_average_count",        VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, PID_DTERM_AVERAGE_FILTER_BUF_LENGTH } , PG_PID_PROFILE, offsetof(pidProfile_t, dterm_average_count)},
